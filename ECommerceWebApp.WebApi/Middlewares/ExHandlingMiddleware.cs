...
namespace ECommerceWebApp.WebApi.Middlewares
{
    public class ExHandlingMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly ILogger<ExHandlingMiddleware> _logger;
        public ExHandlingMiddleware(RequestDelegate next, ILogger<ExHandlingMiddleware> logger) 
        { 
            _next = next; 
            _logger = logger;
        }
